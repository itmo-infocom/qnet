...
muxers = { 2: ['10.0.0.3:1000 10.0.0.4:1000','10.0.0.3:1001 10.0.0.3:1011', '10.0.0.3:1002 10.0.0.3:1012'],
           3: ['--demux 10.0.0.4:1000 10.0.0.2:1000', '--demux 10.0.0.4:1003 10.0.0.2:1000', '--demux 10.0.0.4:1004 10.0.0.2:1000'],
           4: ['10.0.0.5:1000 10.0.0.2:1000','10.0.0.5:1001 10.0.0.5:1011', '10.0.0.5:1002 10.0.0.5:1012'],
           1: ['--demux 10.0.0.2:1000 10.0.0.100:3128', '--demux 10.0.0.2:1003 10.0.0.100:3128', '--demux 10.0.0.2:1004 10.0.0.100:3128']}
    ...
    for i,host in enumerate([n1,n2,n3,n4,n5]):
        if i in (1,2,3,4):
             for n,muxer in enumerate(muxers[i]):
                 host.cmd('python run_daemon.py start muxer_h%s_n%s /usr/bin/tcpmux %s'%(i,n, muxer))
             host.cmd('/usr/bin/stunnel conf/stunnel-n%s.conf  & '%(i+1))   
             host.cmd('python run_daemon.py start qcrypt_h%s /usr/bin/qcrypt conf/qcrypt-n%s.cfg'%(i+1,i+1))
